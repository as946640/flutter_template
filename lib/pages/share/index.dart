...
class Share extends StatefulWidget {
  ...
  @override
  State<Share> createState() => _ShateState();
}

class _ShateState extends State<Share> {
  String _resultString = "显示结果";
  JShare jShare = JShare();
  ...
  Future<void> initPlatformState() async {
    JShareConfig shareConfig = new JShareConfig(appKey: Config.jAppKey);
          ...
          return Column(
            children: <Widget>[
                        ...
                        child: Button(
                          ...
                          onPressed: () {
                            jShare
                                .isPlatformAuth(
                                    platform: JSharePlatform.wechatSession)
                                .then((JShareResponse response) {
                              setState(() {
                                _resultString =
                                    "是否授权：" + response.toJsonMap().toString();
                              });
                            }).catchError((error) {
                              setState(() {
                        ...
                        child: Button(
                          ...
                          onPressed: () {
                            jShare
                                .authorize(
                                    platform: JSharePlatform.wechatSession)
                                .then((JShareSocial value) {
                              setState(() {
                                _resultString =
                                    "授权：" + value.toJsonMap().toString();
                              });
                            }).catchError((error) {
                              setState(() {
                        ...
                        child: Button(
                          ...
                          onPressed: () {
                            jShare
                              ...
                              setState(() {
                                _resultString =
                                    "取消授权：" + response.toJsonMap().toString();
                              });
                            }).catchError((error) {
                              setState(() {
              ...
              Button(
                ...
                onPressed: () {
                  jShare
                      .getUserInfo(platform: JSharePlatform.wechatSession)
                      .then((JShareUserInfo info) {
                    setState(() {
                    ...
                    children: <Widget>[
                      Padding(
                          ...
                          child: GestureDetector(
                            child: Image.asset(
                              'images/${platfromList[index]["icon"]}',
                              width: 50,
                              height: 50,
                              fit: BoxFit.fill,
                            ),
  ...
  void _didSelectPlatform({required int index}) async {
    ...
    if (shareType == JShareType.audio) {
      ...
      if (message.platform == JSharePlatform.qZone ||
        ...
        message.url =
            "http://v.youku.com/v_show/id_XOTQwMDE1ODAw.html?from=s1.8-1-1.2&spm=a2h0k.8191407.0.0";
      }
  ...
  Future<Uint8List> _getAssetsImageBytes(String imagePath) async {
    ...
    ByteData byteData = await rootBundle.load("images/" + imagePath);
  ...
  Future<String> _saveFile(
      Directory directory, String name, Uint8List bytes) async {
